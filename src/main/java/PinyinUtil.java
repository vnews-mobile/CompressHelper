public class PinyinUtil {
    ...
    private static TrieTree trieTree = new TrieTree("root");
    ...
    private static String[] spells = {
            ...
            "ng", "ni", "nian", "niang", "niao", "nie", "nin", "ning", "niu", "nong",
            "nou", "nu", "nuan", "nun", "nuo", "nv", "nve", "o", "ou", "pa",
            "pai", "pan", "pang", "pao", "pei", "pen", "peng", "pi", "pian", "piao",
            "pie", "pin", "ping", "po", "pou", "pu", "qi", "qia", "qian", "qiang",
            "qianwa", "qiao", "qie", "qin", "qing", "qiong", "qiu", "qu", "quan", "que",
            "qun", "ran", "rang", "rao", "re", "ren", "reng", "ri", "rong", "rou",
            "ru", "ruan", "rui", "run", "ruo", "sa", "sai", "san", "sang", "sao",
            "se", "sen", "seng", "sha", "shai", "shan", "shang", "shao", "she", "shei",
            "shen", "sheng", "shi", "shou", "shua", "shu", "shuai", "shuan", "shuang", "shui",
            ...
            "zuan", "zui", "zun", "zuo", "v", "i"
    };

    static {
        for (int i = 0; i < spells.length; i++) {
            trieTree.insert(spells[i]);
        }
    }

    public static String parser(String spell) {
       return trieTree.splitSpell(spell);
    }

    public static void main(String[] args) {
        System.out.println(PinyinUtil.parser("huanyingni"));
    }
